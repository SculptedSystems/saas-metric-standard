...
- No entry in `classic-errors.md` maps directly. The live errors are treating an uncodified convention as a standard, asserting the >= 4 cutoff as settled, and inheriting the **gross-vs-net churn** confusion through a mis-split denominator (folding contraction into churn or vice versa).
